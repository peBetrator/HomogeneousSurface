...
void AstroidConeLit::draw() const {
    ...
    // Материал FRONT (пурпурный) / BACK (оранжевый) для астроиды
    const GLfloat frontAmb[4] = { 0.15f, 0.05f, 0.15f, 1.0f };
    const GLfloat frontDif[4] = { 0.85f, 0.25f, 0.85f, 0.85f }; // пурпурный
    const GLfloat frontSpc[4] = { 0.40f, 0.20f, 0.40f, 0.85f };
